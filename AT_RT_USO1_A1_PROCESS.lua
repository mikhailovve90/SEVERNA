...
local oldTimes={} -- массив предыдущего времени изменения дискрета

local g_pulse_duration=10 -- минимально допустимая длительность входного импульса, мс  (если меньше - то отсечка дребезга контактов) -- величина дребезга в мс
