...
local function Process_DI_Data(Signal) -- обработка входных дискретов
	...
	--	local user="USER_:)"			
		...
		-- проверка изменения сигнала
			...
			if DI_Signals[InputName]["InvFlag"]==true then--сигнал инвертированный,
				OutDI= not OutDI -- имзменим на противоположное
			end --if DI_Signals[InputName]["InvFlag"]==true --сигнал инвертированный,
...
--Core["GSP_SEV_KSSEV_E_USOE_DI_KRU2_3_SQ_ON.Value"]=true
--!!!!Дискретные входы!!!!---
