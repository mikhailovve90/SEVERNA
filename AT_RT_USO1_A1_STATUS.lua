...
local ScreenID="DIAGN_" -- идентификатор мнемосхемы технологического объекта
local e_type -- тип события(появление/исчезновение)
local Logs=true -- вести логи
local USO_ID="USO1_" -- идентификатор УСО
local ObjID="GSP_SEV_KSSEV_E_"..USO_ID -- идентификатор технологического объекта
local PLC_Name="A1_" -- название контроллера в УСО
local PLC_Desc="УСО1. ПЛК A1. " --описание контроллера в УСО
local ObjDesc= "КТП 1. "--описание источника сигналов
