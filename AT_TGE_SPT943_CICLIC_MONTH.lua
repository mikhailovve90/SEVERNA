	...
	local pathHour_1 = "C:/!Projects/Energy_Accounting_T_v3/ArchiveFiles/HourArchive_1.txt";
	local pathDate_1 = "C:/!Projects/Energy_Accounting_T_v3/ArchiveFiles/DateArchive_1.txt";
	local pathMonth_1 = "C:/!Projects/Energy_Accounting_T_v3/ArchiveFiles/MonthArchive_1.txt";
	
	local pathHour_2 = "C:/!Projects/Energy_Accounting_T_v3/ArchiveFiles/HourArchive_2.txt";
	local pathDate_2 = "C:/!Projects/Energy_Accounting_T_v3/ArchiveFiles/DateArchive_2.txt";
	local pathMonth_2 = "C:/!Projects/Energy_Accounting_T_v3/ArchiveFiles/MonthArchive_2.txt";
	...
	fd = io.open( pathMonth_1, "r");							-- открыть файл месячного архива ТВ1 на чтение
	if fd == nil then											-- проверка открытия файла месячного архива ТВ1
...
function f2()
	if Core.StartRequestMonth == true then
		f1();
	end
end
Core.onExtChange( {"StartRequestMonth"}, f2);
Core.waitEvents();